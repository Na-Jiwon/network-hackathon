...
통신망 안정성 확보를 위한 인공지능 해커톤 — **최우수상 수상** (전체 158팀 참가)
...
### 📡 [해커톤/ML] ETRI·KT AI 해커톤 최우수상 — 무선트래픽 예측 (시계열)
...
### 🚨 [해커톤/NLP] ETRI·KT AI 해커톤 최우수상 — 장애경보 분류 (텍스트분류)
...
### 🤖 [개인프로젝트/LLM] 해커톤 수동 규칙 한계를 RAG Agent로 개선

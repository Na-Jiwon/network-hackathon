...
→ [fault-alarm-classification](../fault-alarm-classification) 프로젝트의 수작업 한계를 AI 자동화로 대체한 확장 프로젝트

| 항목 | 내용 |
|------|------|
| 역할 | RAG 파이프라인 설계, Threshold 기반 검색 전략 수립, ReAct Agent 구성, 프롬프트 설계, Streamlit UI 구현 |
| 기반 프로젝트 | fault-alarm-classification (해커톤 분야2 3위 / 59팀) |
